...
func UploadAvatar(c *gin.Context) {
	...
	if !allowedAvatarExtension(ext) {
		c.JSON(http.StatusBadRequest, gin.H{"error": "Format accepte: jpg, jpeg, png, webp ou gif."})
		return
	}
	...
	c.JSON(http.StatusOK, gin.H{"message": "Photo de profil mise a jour.", "avatar_url": avatarURL})
}
