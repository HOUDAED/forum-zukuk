...
func PasswordPolicyMessage() string {
	return "Le mot de passe doit contenir au moins 12 caractères avec majuscule, minuscule, chiffre et caractère spécial, ou 14 caractères avec majuscule, minuscule et chiffre, ou une phrase de passe d'au moins 7 mots."
}
