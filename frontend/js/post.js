...
const avatarHTML = cm.avatar_url
    ? `<img src="${cm.avatar_url.startsWith('http') ? cm.avatar_url : (window.location.hostname === 'localhost' ? 'http://localhost:8081' : '') + cm.avatar_url}" style="width:100%;height:100%;object-fit:cover;border-radius:50%" alt="avatar">`
